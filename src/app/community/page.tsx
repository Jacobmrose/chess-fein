    ...
    <div className='min-h-screen w-full bg-gradient-to-br from-purple-900 to-black flex flex-col items-center px-4 pt-8'>
      ...
      <div className='mt-12 grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl'>
        ...
        <div className='bg-purple-900 p-8 rounded-lg shadow-md hover:bg-gray-700 transition cursor-pointer flex flex-col items-center justify-center'>
          <FaGithub className='text-white w-20 h-20 mb-4' />
        ...
        {/* Discord Server */}
        <div className='bg-purple-900 p-8 rounded-lg shadow-md hover:bg-gray-700 transition cursor-pointer flex flex-col items-center justify-center'>
          <FaDiscord className='text-white w-20 h-20 mb-4' />
          <h3 className='text-xl font-semibold mb-2 text-white text-center'>
            Join Our Discord
          </h3>
          <p className='text-purple-300 text-center'>
        ...
        {/* Community Events */}
        <div className='bg-purple-900 p-8 rounded-lg shadow-md hover:bg-gray-700 transition cursor-pointer flex flex-col items-center justify-center'>
          <GiCalendar className='text-white w-20 h-20 mb-4' />
          <h3 className='text-xl font-semibold mb-2 text-white text-center'>
            Community Events
          </h3>
          <p className='text-purple-300 text-center'>
        ...
        {/* Submit Feedback */}
        <div className='bg-purple-900 p-8 rounded-lg shadow-md hover:bg-gray-700 transition cursor-pointer flex flex-col items-center justify-center'>
          <GiTeamIdea className='text-white w-20 h-20 mb-4' />
          <h3 className='text-xl font-semibold mb-2 text-white text-center'>
            Submit Feedback
          </h3>
          <p className='text-purple-300 text-center'>
      ...
      <div className='mt-16 flex flex-col items-center mb-16'>
        ...
        <button
          className='mt-8 px-8 py-3 bg-purple-700 text-white rounded-lg hover:bg-purple-300 hover:text-black transition'
